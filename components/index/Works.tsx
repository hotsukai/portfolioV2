    ...
    <SectionHeightScreen className="flex justify-between snap-center">
      ...
      <div className="p-10 w-11/12 bg-white">
        ...
        <div className="my-6">
          ...
          <div className="overflow-x-scroll h-44 md:h-60 lg:h-96">
            <div className="flex">
              {products.map((product) => (
                <div key={product.title}>
                  ...
                  <div className="relative z-0 w-40 h-40 bg-slate-800 border border-white md:w-56 md:h-56 lg:w-80 lg:h-80">
                    {product.coverImage && (
                      <Image
                    ...
                    <div className="flex absolute z-10 flex-col justify-center w-40 h-40 text-center text-white bg-slate-800/30 hover:opacity-100 transition-opacity md:w-56 md:h-56 lg:w-80 lg:h-80 lg:bg-slate-800/70 lg:opacity-0">
                      <p>{product.title}</p>
                      ...
                      {product.GitHub && (
                        ...
                        >
                          <svg
                            ...
                            className="inline h-6 fill-white"
                          >
                            <title>GitHub</title>
