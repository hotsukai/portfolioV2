    ...
    {products.map((product) => (
      <div key={product.title}>
        ...
        <div className="relative z-0 w-40 h-40 bg-slate-800 border border-white md:w-56 md:h-56 lg:w-80 lg:h-72">
          ...
          <div className="flex absolute z-10 flex-col justify-center w-40 h-40 text-center text-white bg-slate-800/30 hover:opacity-100 transition-opacity md:w-56 md:h-56 lg:w-80 lg:h-72 lg:bg-slate-800/70 lg:opacity-0">
            <p>{product.title}</p>
